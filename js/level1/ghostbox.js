function GhostBox (options) {
  ...
  self.images = [
    {block: self.blocks.topLeft4, x: 0, y: 0},
    {block: self.blocks.bottomHorizontal1, x: 1, y: 0},
    {block: self.blocks.doorwayLeft, x: 2, y: 0},
    {block: self.blocks.doorwayRight, x: 5, y: 0},
    {block: self.blocks.bottomHorizontal1, x: 6, y: 0},
    {block: self.blocks.topRight4, x: 7, y: 0},
    {block: self.blocks.rightVertical1, x: 0, y: 1},
    {block: self.blocks.leftVertical1, x: 7, y: 1},
    {block: self.blocks.rightVertical1, x: 0, y: 2},
    {block: self.blocks.leftVertical1, x: 7, y: 2},
    {block: self.blocks.rightVertical1, x: 0, y: 3},
    {block: self.blocks.leftVertical1, x: 7, y: 3},
    {block: self.blocks.bottomLeft4, x: 0, y: 4},
    {block: self.blocks.topHorizontal1, x: 1, y: 4},
    {block: self.blocks.topHorizontal1, x: 2, y: 4},
    {block: self.blocks.topHorizontal1, x: 3, y: 4},
    {block: self.blocks.topHorizontal1, x: 4, y: 4},
    {block: self.blocks.topHorizontal1, x: 5, y: 4},
    {block: self.blocks.topHorizontal1, x: 6, y: 4},
    {block: self.blocks.bottomRight4, x: 7, y: 4}
  ];
