function InvertedT1 (options) {
  ...
  self.images = [
    {block: self.blocks.topLeft2, x: 5, y: 0},
    {block: self.blocks.topRight2, x: 6, y: 0},
    {block: self.blocks.leftVertical2, x: 5, y: 1},
    {block: self.blocks.rightVertical2, x: 6, y: 1},
    {block: self.blocks.leftVertical2, x: 5, y: 2},
    {block: self.blocks.rightVertical2, x: 6, y: 2},
    ...
    {block: self.blocks.topHorizontal2, x: 4, y: 3},
    {block: self.blocks.bottomRight3, x: 5, y: 3},
    {block: self.blocks.bottomLeft3, x: 6, y: 3},
