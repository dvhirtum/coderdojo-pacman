function FlippedT2 (options) {
  ...
  self.images = [
    ...
    {block: self.blocks.topRight3, x: 3, y: 4},
    {block: self.blocks.rightVertical2, x: 4, y: 4},
    {block: self.blocks.leftVertical2, x: 3, y: 5},
    {block: self.blocks.rightVertical2, x: 4, y: 5},
    {block: self.blocks.leftVertical2, x: 3, y: 6},
    {block: self.blocks.rightVertical2, x: 4, y: 6},
    {block: self.blocks.bottomLeft2, x: 3, y: 7},
    {block: self.blocks.bottomRight2, x: 4, y: 7}
  ];
