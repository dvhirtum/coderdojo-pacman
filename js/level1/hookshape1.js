function HookShape1 (options) {
  ...
  self.images = [
    ...
    {block: self.blocks.topRight2, x: 3, y: 0},
    {block: self.blocks.bottomLeft2, x: 0, y: 1},
    {block: self.blocks.bottomHorizontal2, x: 1, y: 1},
    {block: self.blocks.topRight3, x: 2, y: 1},
    {block: self.blocks.rightVertical2, x: 3, y: 1},
    {block: self.blocks.leftVertical2, x: 2, y: 2},
    {block: self.blocks.rightVertical2, x: 3, y: 2},
    {block: self.blocks.leftVertical2, x: 2, y: 3},
    {block: self.blocks.rightVertical2, x: 3, y: 3},
    {block: self.blocks.bottomLeft2, x: 2, y: 4},
    {block: self.blocks.bottomRight2, x: 3, y: 4}
  ];
