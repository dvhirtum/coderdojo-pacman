function TShape (options) {
  ...
  self.images = [
    {block: self.blocks.topLeft2, x: 0, y: 0},
    {block: self.blocks.topHorizontal2, x: 1, y: 0},
    {block: self.blocks.topHorizontal2, x: 2, y: 0},
    {block: self.blocks.topHorizontal2, x: 3, y: 0},
    {block: self.blocks.topHorizontal2, x: 4, y: 0},
    {block: self.blocks.topHorizontal2, x: 5, y: 0},
    {block: self.blocks.topHorizontal2, x: 6, y: 0},
    {block: self.blocks.topRight2, x: 7, y: 0},
    {block: self.blocks.bottomLeft2, x: 0, y: 1},
    {block: self.blocks.bottomHorizontal2, x: 1, y: 1},
    {block: self.blocks.bottomHorizontal2, x: 2, y: 1},
    {block: self.blocks.topRight3, x: 3, y: 1},
    {block: self.blocks.topLeft3, x: 4, y: 1},
    {block: self.blocks.bottomHorizontal2, x: 5, y: 1},
    {block: self.blocks.bottomHorizontal2, x: 6, y: 1},
    {block: self.blocks.bottomRight2, x: 7, y: 1},
    {block: self.blocks.leftVertical2, x: 3, y: 2},
    {block: self.blocks.rightVertical2, x: 4, y: 2},
    {block: self.blocks.leftVertical2, x: 3, y: 3},
    {block: self.blocks.rightVertical2, x: 4, y: 3},
    {block: self.blocks.bottomLeft2, x: 3, y: 4},
    {block: self.blocks.bottomRight2, x: 4, y: 4}
  ];
